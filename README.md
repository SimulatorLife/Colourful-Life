...
- **Experience-driven social momentum**: each organism carries a DNA-tuned interaction mood that swings with recent fights or cooperative exchanges. Brains receive that momentum as a live sensor so aggression, alliances, and mate choices emerge from lived history instead of scripted toggles.
