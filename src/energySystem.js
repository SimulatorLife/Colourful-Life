 ...
 * @param {number} [options.neighborSum] - Precomputed sum of neighbour
 *   energies.
 * @param {number} [options.neighborCount] - Precomputed count of contributing
 *   neighbours used with `neighborSum`.
 * @param {Array<number>} [options.neighborEnergies] - Individual neighbour
 *   energy samples when aggregate values are unavailable.
 * @returns {number|null} Arithmetic mean of neighbour energies when available;
 *   otherwise `null`.
 */
